 ...
 */
public class PurchaseUpdateFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.fragment_purchase_update, container, false);
        recyclerView=view.findViewById(R.id.purchase_recycler_view);
        sms=callback.getMessages(Types.PurchaseUpdateFragment);
